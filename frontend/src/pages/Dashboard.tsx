...
// 
// Page Principale apres connexion. Elle affiche les statistiques
// de l utilisateur via le hook useFetch (appel GET /api/stats/progression).
// Illustre: chargement asynchrone, rendu conditionnel, graphique Redcharts
// et composant interne(statCard)
//==============================================================================

import { Link } from 'react-router-dom'
// Recharts : librairioe de graphiques React (composants déclaratifs)
import {
...
// Mapping num du mois -label visible
const GOAL_LABELS: Record<string, string> = {
    lose: 'Perste de poids',
    maintain: 'Maintien du poid',
    gain: 'Prise de Masse'

}
// Mapping valeur BDD -Abreviation francaise
const MONTH_LABELS: Record<string, string> = {
    '01': 'Jan', '02': 'Fev','03': 'Mar','04': 'Avr',
    '05': 'Mai', '06': 'Juin','07': 'Juil','08': 'Aout',
    '09': 'Sept', '10': 'Octev','11': 'Nov','12': 'Dec',
}
...
// convertit "2004-01-15" en date locale FR sans décalage horaire
// (new Date('2024-01-15') interprete en UTC - probleme de fuseau horaire)
...
export default function Dashboard() {
    ...
    // le generique <ProgressionStats> type de reponse pour type script
    ...
    const stats = data?.stats // ? . - operateur optionnel 

    // Preparation des données pour recharts:
    ...
    // Total pour calcule le % de chaque categorie dans les barres
